...
Modal analysis of a simply-supported steel beam: FEM vs analytical solution.

System description
^^^^^^^^^^^^^^^^^^

The beam is simply supported at :math:`x = 0` (displacement zero) and :math:`x = L` (displacement zero). It has length :math:`L`, Young's modulus :math:`E`, density :math:`\rho`,
